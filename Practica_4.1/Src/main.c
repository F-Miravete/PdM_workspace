...
//*********************************************************************************************************
// Defino variables globales de retardo, duracion y estado de MEF
//*********************************************************************************************************
delay_t retardo;
tick_t duration = DURATION_DELAY;
...
int main(void)
{
  ...
  //*********************************************************************************************************
  // Pongo en cero las 3 salidas correspondientes a los 3 leds cableados
  //*********************************************************************************************************
  HAL_GPIO_WritePin(GPIOB, LED01_Pin, 0);
  HAL_GPIO_WritePin(GPIOB, LED02_Pin, 0);
...
//**********************************************************************************************************
//
// Practica 4 Punto 1 - Programacion de Microcontroladores (CESE 2023)
